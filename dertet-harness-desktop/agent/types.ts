...
export interface Settings {
  ...
  ffmpegPath?: string;
  /** UI language code (e.g. "uk", "en") the renderer resolved and is currently displaying in — lets
   *  backend-generated text (slash-command replies, agent activity labels) match it instead of always
   *  being Ukrainian. Absent for settings saved before this existed; callers should default to "uk". */
  language?: string;
}
